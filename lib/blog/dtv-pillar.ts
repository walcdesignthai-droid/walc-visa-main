...
export const DTV_PILLAR: Article = {
	...
	answerFirst: [
		...
		`WALC では DTV を、ソフトパワー枠 ${FEE_SOFT_POWER}・ノマド ${FEE_NOMAD}・フリーランス ${FEE_FREELANCE}の表示料金で取り扱っています。${FEE_SUMMARY} 本ガイドでは要件・費用・滞在ルールを、一次出典に沿って整理します。`,
	],
	...
	steps: [
		...
		{
			heading: "3. 申請・取得",
			body: `必要書類を整え、e-Visa ルートで申請します。WALC の表示料金には書類作成・申請サポートも含まれます。${FEE_SUMMARY}`,
		},
	],
