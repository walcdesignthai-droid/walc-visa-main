...
export const THAILAND_NOMAD_VISA_GUIDE: Article = {
	...
	// --- answer-first(冒頭で結論) -------------------------------------------
	answerFirst: [
		"「タイのノマドビザ」——よく聞く呼び名ですが、正式には DTV(Destination Thailand Visa/ディスティネーション・タイランド・ビザ)を指します。「デジタルノマドビザ」と呼ばれることもありますが、正式名称は Destination Thailand Visa、通称「ノマドビザ」です。2024 年 7 月 15 日に始まった、リモートワーカー・フリーランス・ソフトパワー活動者向けの長期ビザで、5 年マルチプル・1 回最長 180 日(国内で +180 日の延長可)という自由度が特徴です(タイ外務省 DTV 情報・e-Visa 公式)。",
	...
	bodySections: [
		{
			...
			items: [
				...
				"制度上の申請費用: 10,000 バーツ(日本からの申請は 52,000 円 ※2026 年 5 月時点・大使館案内)。WALC の表示料金にはこの申請費用を含みます。ご自身で申請する場合は申請先の最新案内をご確認ください",
	...
	sources: [
		...
		{
			claim: "日本からの申請料 52,000 円(2026 年 5 月時点)",
			source: "申請先 タイ大使館・領事館の案内(2026 年 5 月時点・Cowork 確認)",
		},
		{
	...
	// --- 未確定(本文に書かない)= 公開前に要確認 --------------------------
	// WI-line-link-unify(2026-06-06): 施行日 2024/7/15・円換算 52,000円(2026年5月時点・
	// 大使館案内)を Cowork 確定 → 本文化済み。残課題なし。
	placeholders: [],
};
