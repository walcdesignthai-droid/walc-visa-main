...
export const QA_REENTRY_PERMIT: Article = {
	...
	title: "タイのリエントリーパーミット(TM.8)取得方法【2026年版】— 出国前に取得を",
	...
	answerFirst: [
		...
		"再入国許可を出国前に取得しておけば、戻ってから残りのビザ期間をそのまま継続できます。一時帰国・近隣国出張の前に、最も取り忘れてはいけない手続きです。",
	],
	...
	sources: [
		{
			claim: "リエントリーパーミット(TM.8)の必要性・種類・料金(1,900/3,800 バーツ)・取得場所・手順",
			source: "Immigration Division 1(Bangkok)Re-entry Permit / 手数料 / タイ入国管理局 Public Handbook",
		},
	],
