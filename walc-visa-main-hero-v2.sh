#!/bin/bash
# ============================================================================
# walc-visa-main Hero v2.0 刷新
# ----------------------------------------------------------------------------
# - components/lp/Hero.tsx 新規(コーポレート感・信頼感・頼みやすさ)
# - components/lp/TrustStrip.tsx 新規(実績ストリップ)
# - app/page.tsx 置き換え(Hero + TrustStrip + Coming Soon minify)
# ============================================================================
...
echo "→ Generate TrustStrip.tsx"

cat > "$WMV/components/lp/TrustStrip.tsx" <<'TRUST_EOF'
/**
...
echo "→ git commit"
git add -A
git commit -m "feat(hero): redesign hero with corporate trust elements

- Hero v2.0: navy gradient + WALC logo pattern background
- Gold thin line accent (top edge, signal of trust)
- Floating achievement cards (212/212, 300+, 6年) on right
- TRUSTED VISA SPECIALISTS caption
- CTA: LINE 3-min consult + 専門家に相談 (24h response)
- TrustStrip with 5 metric items below hero
- Minify Coming Soon to thin banner"

echo ""
echo "============================================================================"
echo "✓ Hero v2.0 applied!"
echo "============================================================================"
echo ""
echo "Next:"
echo "  pnpm dev          # 確認"
