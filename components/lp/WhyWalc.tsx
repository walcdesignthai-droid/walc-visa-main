...
export async function WhyWalc() {
	...
	const REASONS = [
		...
		{
			Icon: Smartphone,
			labelKey: "LINE + Customer Portal",
			title: "LINE相談から進捗確認まで連携",
			body: "相談と正式申込のご案内はLINE、申込後の進捗確認と追加書類の提出はお客様専用画面。役割を分けることで、連絡先と案件情報を迷わず確認できます。",
			metric: { value: "2 つの窓口", label: "LINE相談＋申込後専用画面" },
		},
		{
			Icon: MapPin,
